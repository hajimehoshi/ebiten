...
func TestXlibStructSizes(t *testing.T) {
	checks := []struct {
		...
		{"XIMCallback", unsafe.Sizeof(_XIMCallback{}), sizeofXIMCallback},
		{"XIMText", unsafe.Sizeof(_XIMText{}), sizeofXIMText},
		{"XIMPreeditDrawCallbackStruct", unsafe.Sizeof(_XIMPreeditDrawCallbackStruct{}), sizeofXIMPreeditDrawCB},
		{"XIMPreeditCaretCallbackStruct", unsafe.Sizeof(_XIMPreeditCaretCallbackStruct{}), sizeofXIMPreeditCaretCB},
