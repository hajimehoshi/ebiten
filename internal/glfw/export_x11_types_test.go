...
// The X11 struct types are unexported, but the black-box ABI test in
// x11_types_linbsd_test.go verifies their sizes and field offsets against the
// C headers. These aliases re-export them for that test.
