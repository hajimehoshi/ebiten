...
func (g *Graphics) draw(rps mtl.RenderPipelineState, dst *Image, dstRegion graphicsdriver.Region, srcs [graphics.ShaderImageCount]*Image, indexLen, indexOffset int, uniforms [][]float32, stencilMode stencilMode) error {
