...
func (c *ColorM) Invert() *ColorM {
	...
	m.body[0] = det * (m11*b234234 - m12*b134234 + m13*b124234)
	m.body[1] = det * -(m01*b234234 - m02*b134234 + m03*b124234)
	m.body[2] = det * (m01*b234134 - m02*b134134 + m03*b124134)
	m.body[3] = det * -(m01*b234124 - m02*b134124 + m03*b124124)
	m.body[4] = det * -(m10*b234234 - m12*b034234 + m13*b024234)
	m.body[5] = det * (m00*b234234 - m02*b034234 + m03*b024234)
	m.body[6] = det * -(m00*b234134 - m02*b034134 + m03*b024134)
	m.body[7] = det * (m00*b234124 - m02*b034124 + m03*b024124)
	m.body[8] = det * (m10*b134234 - m11*b034234 + m13*b014234)
	m.body[9] = det * -(m00*b134234 - m01*b034234 + m03*b014234)
	m.body[10] = det * (m00*b134134 - m01*b034134 + m03*b014134)
	m.body[11] = det * -(m00*b134124 - m01*b034124 + m03*b014124)
	m.body[12] = det * -(m10*b124234 - m11*b024234 + m12*b014234)
	m.body[13] = det * (m00*b124234 - m01*b024234 + m02*b014234)
	m.body[14] = det * -(m00*b124134 - m01*b024134 + m02*b014134)
	m.body[15] = det * (m00*b124124 - m01*b024124 + m02*b014124)
